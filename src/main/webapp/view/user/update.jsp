...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h2 class="text-center">Atualização dos dados do usuário <c:out value="${usuario.nome}"/></h2>
            ...
            <form
                ...
                <div class="form-group">
                    <label for="usuario-sexo" class="control-label">Você identifica como:</label>
                    <select name="sexo" id="usuario-sexo" required>
                ...
                <div class="form-group">
                    <label for="usuario-pais" class="control-label">Em qual país você se encontra:</label>
                    <select name="pais" id="usuario-pais" required>
                        <option value="">Escolha</option>
