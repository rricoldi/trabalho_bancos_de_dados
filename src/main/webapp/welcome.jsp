    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="jumbotron">
                ...
                <p>Este é um agregador de podcasts para o trabalho da disciplina Bancos de Dados A.</p>
                <p>
                    <a class="btn btn-lg btn-primary" href="${pageContext.servletContext.contextPath}/user">
                        Cadastro de usuários
                    </a>    
                    <a class="btn btn-lg btn-primary" href="${pageContext.servletContext.contextPath}/podcast">
